...
- [UX/UI] 2026-08-29: 모바일 환경에서 서술형 응답 시 답답함을 유발했던 단답형 '<input>' 창을, 다중행 입력이 가능하고 iOS 줌인 이슈(font-size < 16px)를 방어하는 '<textarea>' 로 전면 교체(Sniper Edit). (src/components/survey/Inputs.tsx)
