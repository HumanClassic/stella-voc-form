...
export const QUESTIONS: readonly Question[] = [
  ...
  },
  {
    ...
    type: "textarea",
    description: "예: '감정과 제스처까지 써가며 상황에 완벽히 몰입하게 하는 수업',  '입 근육이 뻐근해질 때까지 뱉어내는 강도 높은 아웃풋 훈련',  '쌤 전용 학습 앱 덕분에 24시간 스피킹 밀착 과외를 받는 듯한 기분' 등 가장 큰 차별점을 적어주세요.",
    required: true,
  },
  {
    ...
    type: "textarea",
    description: "예: '영어식 어순대로 생각하고 내뱉는 훈련 덕분에 긴 문장도 덩어리째 이해돼요',  '강세와 연음(리듬) 규칙을 배우고 나니 영어가 귀에 확 꽂혀요' 등 체험하는 가장 큰 변화를 적어주세요.",
    required: true,
  },
  {
