...
export const QUESTIONS: readonly Question[] = [
  ...
  },
  {
    ...
    type: "textarea",
    description: "예: '예전엔 단어만 툭툭 던졌는데 지금은 온전한 문장으로 말하게 됐어요', '외국인 전화가 덜 두려워졌어요' 등 구체적인 에피소드를 적어주시면 좋습니다!",
    required: true,
  },
  {
    ...
    type: "textarea",
    description: "예: '단순 암기가 아닌 영어의 생성 원리를 알려주는 점', '매일 진행되는 꼼꼼한 1:1 피드백' 등 가장 큰 차별점을 적어주세요.",
    required: true,
  },
  {
    ...
    type: "textarea",
    description: "예: '망설임 없이 문장이 바로 나와요', '영어 이메일 작성이 한결 수월해졌어요' 등 체험하는 가장 큰 변화를 적어주세요.",
    required: true,
  },
  {
